...
Frameworks/ APIs&.Net Core, .Net Framework, Java SE, Java EE, Spring, Node.js, Angular, AngularJS, jQuery, Unity 3D, Ring/Compojure, jQuery and more.\\ 
&\\

Platforms&Linux, Windows, Cloud Platforms (AWS, GCP and Azure).\\ 
&\\
...
&I provided Clojure expertise and knowledge transfer to a Woolworths development team supporting the Takeoff micro-fulfillment center (MFC) platform.  I coached team members on Clojure development, established Leiningen-based development environments, and delivered targeted Clojure language training.\\
&\\

&I also analyzed and documented the functionality of numerous microservices and the data warehousing pipeline, disseminating this knowledge through training and a central knowledge base. This enabled the team to effectively maintain and enhance the Takeoff MFC platform, a complex, distributed system built with a varied mixture of technologies and languages.\\ 
&\\
