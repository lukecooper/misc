...
Frameworks/ APIs&.Net Core, .Net Framework, Java SE, Java EE, Spring, Node.js, Angular, Angular JS, jQuery, Unity 3D, Ring/Compojure, jQuery, Nintendo RVL SDK, Microsoft X360 XDK, SCEE SDK.\\ 
&\\

Platforms&Linux, Windows, Cloud Platforms (AWS, GCP and Azure), Sony PlayStation 2/3, Nintendo GameCube/Wii, Microsoft Xbox/Xbox 360.\\ 
&\\

Technologies&PostgreSQL, MySQL, RabbitMQ, Redis, SQL Server, Kafka.
\end{longtable}
\pagebreak
...
2025--2025 &{\bf Westpac Banking Corporation} \textperiodcentered{} \textit{Senior Software Developer}\\ 
&\\
&I contributed to the maintenance and feature development of Westpac Live as part of the \$3.8B Unite program at Westpac. Westpac Live is a high-scale retail and business banking platform serving millions of users and processing billions in weekly transactions.\\ 
&\\

&My work involved navigating a complex legacy .Net Framework codebase to implement critical updates, including the SMS Protect feature to enhance security compliance and the integration of a new API to streamline Worldwide Wallet transfer logic. Additionally, I improved system flexibility for Daily Payment Limits ensuring more scalable administrative control.\\
&\\

2024--2025 &{\bf Woolworths Group} \textperiodcentered{} \textit{Senior Software Developer}\\ 
&\\

&I provided Clojure expertise and knowledge transfer to an internal Woolworths development team responsible for supporting the Takeoff micro-fulfillment center (MFC) platform. The Takeoff platform partially automates the fulfilment of customer orders using a small-footprint robotic warehouse system colocated within Woolworths stores. My role involved coaching team members on Clojure development best practices, establishing Clojure development environments using Leiningen, and delivering comprehensive Clojure language training tailored to the specific needs of the Takeoff system.\\
&\\

&Additionally, I analyzed the functionality of numerous microservices comprising the Takeoff MFC platform, including the data warehousing pipeline, and disseminated this knowledge through detailed documentation, presentations, and hands-on training sessions. This facilitated the team's transition to supporting a complex, distributed system built with an unfamiliar technology stack.\\ 
&\\
